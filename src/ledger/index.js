...
class Ledger {
    ...
    constructTxObj(raw, inputArr, redeemScript) {
    ...
    applyAlreadyExistedSig(txObj, raw) {
    ...
    async sign(raw, inputsObj, redeemScript, network = "mainnet") {
